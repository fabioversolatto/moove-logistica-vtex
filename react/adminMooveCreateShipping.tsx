...
const AdminMooveCreateShipping: FC = () => {
        ...
        <Layout
            ...
            <PageBlock>
                <Input
                    ...
                    label="Client number"
                    error={clientNumber ? "" : "Client number is required"}
                    type="text"
                ...
                <Input
                    ...
                    error={weightInGrams ? "" : "Weight is required"}
                    type="decimal"
                    label="Weight"
                ...
                <Input
                    ...
                    type="text"
                    error={country ? "" : "Recipient's country is required"}
                ...
                <Input
                    ...
                    type="text"
                    error={zipCode ? "" : "Recipient's  ZIP code is required"}
                ...
                <Input
                    ...
                    error={address ? "" : "Recipient's address is required"}
                ...
                <Input
                    ...
                    type="text"
                    error={city ? "" : "Recipient's city is required"}
                ...
                <Input
                    ...
                    type="text"
                    error={state ? "" : "Recipient's state is required"}
                ...
                <Input
                    ...
                    type="text"
                    error={contactName ? "" : "Recipient's contact name is required"}
...
export default AdminMooveCreateShipping
